...
public class TestCases
{
   ...
   {
      Rectangle r = new Rectangle(2, 2, new Point(2, 3), Color.BLACK);

      assertEquals(4, r.getArea(), DELTA);
   }
   ...
   public void testRectangleGetPerimeter()
   {
      ...
      assertEquals(8, r.getPerimeter(), DELTA);
   }

   @Test
   public void testTriangleGetPermimeter()
   {
      Triangle t = new Triangle(new Point(0,0), new Point(2,-4), new Point(3, 0),
              Color.BLACK);

      assertEquals(11.595241580617241, t.getPerimeter(), DELTA);
   }
